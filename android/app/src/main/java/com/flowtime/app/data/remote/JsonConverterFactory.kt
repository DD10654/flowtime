...
/**
 * Minimal Retrofit converter backed by kotlinx.serialization — replaces the
 * external retrofit2-kotlinx-serialization-converter (whose 1.0.0 API isn't
 * reachable from Kotlin). Uses reflection-based [serializer] lookup per type.
 */
